...
import isel.MoP.Controller.User;
...
public class App {
    ...
    public static void init() {
        ...
        frame.setTitle("Java Shopping List Application");
        frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        frame.setSize(DEFAULT_FRAME_DIMENSIONS, DEFAULT_FRAME_DIMENSIONS);
        frame.setLayout(new BorderLayout());

        JLabel logoLabel = new JLabel();
        ImageIcon imageIcon = new ImageIcon("src/main/java/isel.MoP.View/logo.png");
        ...
        ImageIcon createListIcon = ViewUtils.resizeIcon(new ImageIcon("src/main/java/isel.MoP.View/add.png"),
